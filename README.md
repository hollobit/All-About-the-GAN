...
<p align="center"><img width="80%" src="wordcloud_category.png" /><br>(Word Cloud of Category)</p>

<p align="center"><img width="80%" src="wordcloud_abbr.png" width="100%" ALT="Abbr. Name Word Cloud of GAN papers"><br>(Word cloud of Abbr. name)</p>
